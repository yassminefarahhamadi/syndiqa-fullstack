...
@Component({
    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-4">SyndiQA is a smart syndicate management platform built with Angular v21 and PrimeNG v21. The application provides comprehensive tools for managing properties, residents, finances, and more.</p>
            <pre class="app-code">
